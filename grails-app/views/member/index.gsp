            ...
            <div class="btn-group">
                <g:form controller="member" action="index" method="GET">
                    <div class="input-group" id="search-area">
                        <g:select name="colName" class="form-control" from="[firstName: 'Name', email: 'Email']" value="${params?.colName}" optionKey="key" optionValue="value"/>
    ...
    <div class="card-body">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <g:sortableColumn property="birthDate" title="${g.message(code: "age")}"/>
            ...
            <g:each in="${memberList}" var="info">
                <tr>
                    ...
                    <td>${(new Date()-info?.birthDate ).intdiv(365)}</td>
                    <td>${info?.email}</td>
                    <td>${info?.phone}</td>
